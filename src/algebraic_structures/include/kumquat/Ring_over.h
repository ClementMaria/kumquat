...
public:
  ...
  static const bool field = false;//the multiplicative inverse always exists, except for 0
...
/** \brief The type of elements of the group.
  ...
  * Must be copiable. 
  * */
  typedef ScalarRingOperations   Element;
/** \brief A (multiprecision) signed integer type, notably for the outer product 
  ...
  * operators +, -, *, / etc. 
  * */
  typedef typename Element::Integer Integer;
