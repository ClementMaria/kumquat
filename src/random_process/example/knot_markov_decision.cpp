...
int main(int argc, char * argv[]) {
  ...
  // std::vector<size_t> starting_state = {19, 841, 7, 880, 34, 841, 20, 799, 37, 265, 19, 841, 20, 1150, 0, 448, 13, 20, 37, 897, 20, 3, 33, 21, 0, 799, 13, 20, 14, 840, 34, 20, 7, 398, 20, 1364, 29, 0, 10, 375, 20, 1301, 21, 921, 21, 882, 11, 0, 20, 0, 30, 962, 24, 789, 21, 881, 23, 677, 0, 962, 19, 762, 11, 842, 20, 18, 25, 800, 27, 235, 20, 106, 0, 1373, 20, 1645, 19, 1011, 28, 21, 21, 875, 17, 892, 20, 748, 19, 615, 20, 1089, 19, 0, 19, 802, 19, 881, 19, 423, 0, 719, 22};
  // num_strands = 4;//must be even
  // num_layers = 101;//better if odd
  // max_twists = 20;
  // num_iterations = 1000;
  // batch_size = 50;
  // num_pow_train = 1000;
  ...
  std::vector<size_t> starting_state = std::vector<size_t>();
